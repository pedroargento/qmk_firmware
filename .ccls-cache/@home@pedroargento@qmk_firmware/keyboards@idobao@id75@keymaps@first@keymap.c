 ...
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------|
 * | TAB    | Q      | W      | E      | R      | T      | 7      | 8      | 9      | Y      | U      | I      | O      | P      | HOME   |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------+--------|
 * | CAP LK | A      | S      | D      | F      | G      | 4      | 5      | 6      | H      | J      | K      | L      | ;      | ENTER  |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------------------------+--------|
 * | LSHIFT | Z      | X      | C      | V      | B      | 1      | 2      | 3      | N      | M      | ,      | .      | UP     | "      |
 * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+-----------------+--------+--------|
 * | LCTRL  | LGUI   | LALT   | FN     | [      | ]      | BACKSP | ENTER  | SPACE  | \      | `      | /      | LEFT   | DOWN   | RIGHT  |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
 ...
 [_QW] = LAYOUT_ortho_5x15( /* QWERTY */
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_P1,  KC_P2,    KC_P3, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_UP, KC_QUOTE,
    KC_LCTL, KC_LGUI, KC_LALT, MO(_FN), KC_LEFT_BRACKET,  KC_RIGHT_BRACKET,  KC_BSPC, KC_ENT, KC_SPC, KC_NONUS_BACKSLASH, KC_GRAVE, KC_SLSH,  KC_LEFT, KC_DOWN, KC_RIGHT
 ),
